...
**Later / ideas** — collections, BPM/key filters and editing, similarity, cache size caps, multi-user, mobile, internet access. Not in scope until the drag-to-DAW loop works.
